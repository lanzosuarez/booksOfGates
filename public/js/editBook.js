                    ...
                    <div class="container">
                        <div class="columns">
                            <div class="column"><span class="title is-3 is-white">Favorite Books</span>          
                                ...
                                <span class="title is-4 has-text-muted">${favYear}</span>
                            </div>
                        </div>
                    </div>
                    </div>
                    <div class="section viewBook">
                    <div class="container">
                        <div class="columns">
                        <div class="column is-3">
                            ...
                            <ul class="align2">
                                ...
                                <figure class="book">
                                    ...
                                    <li><img src="${book.imageUrl}" alt="" id="imgBook"/><span class="ribbon bestseller">N�1</span></li>
                                    <li></li>
                                    </ul>
                                    <!-- Pages-->
                                    <ul class="page">
                        ...
                        <div class="column is-8 is-offset-1">
                            <div class="title is-2 is-white">${book.title}</div>
                            <p class="title is-3 has-text-muted">${book.price}</p>
                            <hr/><br/>
                            <p align="justify" class="is-white">${book.description}</p>
                            <br/><br/><br/>
                            <table class="table">
                            <tbody>
                                <tr>
                                <td class="has-text-right"><strong class="is-bl">Amazon Link</strong></td>
                                <td class="is-tdsize">${book.link}</td>
                                </tr>
                                <tr>
                                <td class="has-text-right"><strong class="is-bl">Year Published</strong></td>
                                <td class="is-tdsize">${book.published}</td>
                                </tr>
                                <tr>
                                <td class="has-text-right"><strong class="is-bl">Date Created</strong></td>
                                <td class="is-tdsize">${date}</td>
                                </tr>
                                <tr>
                                <td class="has-text-right"><strong class="is-bl">Date Updated</strong></td>
                                <td class="is-tdsize">${update} ${day} ago</td>
                                </tr>
                                <tr></tr>
                            </tbody>
                            </table>
