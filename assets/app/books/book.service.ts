...
export class BookService {
  private  books: Book[] = [
    ...
    new Book(3,'fdf','fdfdf','dfdfdf','dfdfdfd','dfdfdfd','dfdfdfd','https://images-na.ssl-images-amazon.com/images/I/51uj--DYaSL.jpg','Aug 10,2015', 'Aug 10,2015'),
    new Book(4,'fdf','fdfdf','dfdfdf','dfdfdfd','dfdfdfd','dfdfdfd','https://images-na.ssl-images-amazon.com/images/I/51uj--DYaSL.jpg','Aug 10,2015', 'Aug 10,2015'),
  ];
  getBooks(){
    return this.books;
  }
